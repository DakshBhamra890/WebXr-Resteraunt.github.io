...
const createScene = async function() {
   ...
   // creating the chess like ground
    ...
    wallmaterial.diffuseColor = new BABYLON.Color3(0.9, 0.6, 0.5); // Red color
...
// adding the roof
    ...
    roofFlat.material = wallmaterial;
    ...
    roofTraingle1.material = wallmaterial;
